...
import { getCurrentUser, setCurrentUser, getAllUsers } from '../utils/authStorage';
...
export default function ChangePassword() {
    ...
    const handleChangePassword = async () => {
        ...
        try {
            ...
            if (!currentUser) {
                Alert.alert(translations.error, translations.userNotFound);
                setLoading(false);
                return;
            }
            ...
            if (currentUser.password !== currentPassword) {
                Alert.alert(translations.error, translations.currentPasswordWrong);
                setLoading(false);
                return;
            }
        ...
        <ScrollView style={[styles.container, { backgroundColor: isDarkMode ? theme.background : '#f8f9fa' }]}>
            ...
            <View style={styles.content}>
                ...
                <View style={[styles.form, { backgroundColor: isDarkMode ? '#333' : '#fff' }]}>
                    ...
                    >
                        {loading ? (
                            <Text style={styles.buttonText}>{translations.changing}...</Text>
                        ) : (
                            <>
